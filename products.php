			...
			<div class="row">
				...
				<h1>accessories</h1>
					<div class="single-banner">
						<a href= "acces.php"><img src="images/toy4.jfif" alt="acces.php"></a>
						<div class="content">
							<p>accessories</p>
							<h3>toys <br> collection</h3>
							<a href="acess.php">Discover Now</a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
				...
				<h1>suppliments</h1>
					<div class="single-banner">
					<a href= "supl.php"><img src="images/sup1.jfif" alt="supl.php"></a>
						<div class="content">
							<p>suppliments</p>
							<h3>milk <br> vitamin</h3>
							<a href="#">Shop Now</a>
						</div>
					</div>
				</div>
				...
				<h1>cloths</h1>
					...
					<a href= "acces.php"><img src="images/cloth.jfif" alt="cloth.php"></a>
						<div class="content">
							<p>cloths</p>
							<h3>cloths for kids <br> Up to <span>20%</span> Off</h3>
				...
				<div class="row">
						...
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										...
										<li><a href="supl.php">suppliments</a></li>
								...
								<div class="single-widget recent-post">
									...
									<!-- Single Post -->
									<?php
									$query1 = " SELECT  * from product order by date desc limit 4 ";
									...
									<div class="single-post first">
										...
										<div class="content">
											...
											<p class="price"><?php echo $row1['price']; ?> birr</p>
											<ul class="reviews">
					...
					<div class="col-lg-9 col-md-8 col-12">
						<div class="row">
							...
							$query1 = " SELECT  * from product  limit 25 ";
							$result1 = mysqli_query($conn, $query1);
							$sth1 = $conn->query($query1);
							$row1=mysqli_fetch_array($sth1);
